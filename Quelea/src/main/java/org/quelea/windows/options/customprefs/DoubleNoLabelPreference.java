...
public class DoubleNoLabelPreference extends SimpleControl<DoubleField, HBox> {
    /**
     ...
     */
    public DoubleNoLabelPreference(double min, double max, int precision) {
        super();
        this.min = min;
        this.max = max;
    ...
    public void layoutParts() {
        node.getChildren().addAll(slider);
