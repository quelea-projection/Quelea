...
/**
 * Parses a PDF from the survivor songbook, this must be the acetates PDF
 * containing only the lyrics (not the guitar chords or sheet music!)
 * @author Michael
 */
public class SurvivorSongbookParser {
    ...
    /**
     * Get the author from the text. Footer must be on when this method is
     * called!
