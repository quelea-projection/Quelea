...
public class SavePanelDrawer implements SecondPanelDrawer {
    ...
    public void draw(JPanel panel) {
        ...
        graphics.drawString(LabelGrabber.INSTANCE.getLabel("save.schedule.text"), 20, 40);
        graphics.setFont(new Font("Verdana", 0, 14));
        graphics.drawString(LabelGrabber.INSTANCE.getLabel("save.schedule.disk.text"), 20, 60);
    }
